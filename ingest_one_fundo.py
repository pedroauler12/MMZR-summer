...
# -*- coding: utf-8 -*-
"""
Fase 1 - Ingestão de UM novo fundo (staging) sem tocar no pipeline oficial.
Versão v3:
  - Detector de coluna % mais robusto (aceita '% do PL' XP, NBSP, etc.)
  - Ordem final de colunas: NOME DO FUNDO, ATIVO, CÓDIGO DO ATIVO, % DA CARTEIRA, Norm., GARANTIAS
  - Mensagens de depuração quando coluna % não encontrada
  - Parâmetro opcional --perc-col para forçar a coluna manualmente

Uso:
    python ingest_one_fundo_v3.py input_dados/planilha-XPCI11.xlsx XPCI11 "Portfolio" 10 --outdir input_dados
"""
